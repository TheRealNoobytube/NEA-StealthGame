...
void Enemy::ready() {
	...
	collision.position = Vector2D(0, -2);
	...
	sprite.createAnimation("MoveUp", { 1,2,3,4,5 }, false, false, animationFps, true);

	sprite.createAnimation("IdleUpRight", { 6 });
	sprite.createAnimation("MoveUpRight", { 7,8,9,10,11 }, false, false, animationFps, true);

	sprite.createAnimation("IdleRight", { 12 });
	sprite.createAnimation("MoveRight", { 13,14,15,16,17 }, false, false, animationFps, true);

	sprite.createAnimation("IdleDownRight", { 18 });
	sprite.createAnimation("MoveDownRight", { 19,20,21,22,23 }, false, false, animationFps, true);

	sprite.createAnimation("IdleDown", { 24 });
	sprite.createAnimation("MoveDown", { 25,26,27,28,29 }, false, false, animationFps, true);
